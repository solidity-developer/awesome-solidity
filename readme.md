...
- [Slang](https://github.com/NomicFoundation/slang) - Rust-based compiler API for building Solidity analysis and tooling, with omni-version support across 80+ Solidity versions. [![Stars](https://badgen.net/github/stars/NomicFoundation/slang)](https://github.com/NomicFoundation/slang)
